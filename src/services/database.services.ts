...
class DatabaseService {
  ...
  get users(): Collection<User> {
    return this.db.collection(envConfig.DB_COLLECTION_USERS as string)
  }

  get refreshTokens(): Collection<RefreshToken> {
    return this.db.collection(envConfig.DB_COLLECTION_REFRESH_TOKENS as string)
  }

  get followers(): Collection<Follower> {
    return this.db.collection(envConfig.DB_COLLECTION_FOLLOWERS as string)
  }

  get videoStatus(): Collection<VideoStatus> {
    return this.db.collection(envConfig.DB_COLLECTION_VIDEO_STATUS as string)
  }

  get tweets(): Collection<Tweet> {
    return this.db.collection(envConfig.DB_COLLECTION_TWEETS as string)
  }

  get hashTags(): Collection<HashTag> {
    return this.db.collection(envConfig.DB_COLLECTION_HASHTAGS as string)
  }

  get bookmarks(): Collection<Bookmark> {
    return this.db.collection(envConfig.DB_COLLECTION_BOOKMARKS as string)
  }

  get likes(): Collection<Like> {
    return this.db.collection(envConfig.DB_COLLECTION_LIKES as string)
  }

  get conversations(): Collection<Conversation> {
    return this.db.collection(envConfig.DB_COLLECTION_CONVERSATIONS as string)
  }
}
